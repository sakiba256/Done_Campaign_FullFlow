...
class Audience {
  ...
  async  addAudience () {
    try {
        ...
        await this.page.fill('//input[@placeholder="Audience Name"]', '115. SNS Automated Audience');
        await this.page.waitForTimeout(1000);
        ...
        await this.page.fill('//input[@placeholder="Description"]', '115. SNS Automated Audience');
        await this.page.waitForTimeout(1000);
